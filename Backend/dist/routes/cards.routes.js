...
const card_controllers_1 = require("../controllers/card.controllers");
 ...
 */
cardRouter.get('/', card_controllers_1.getCards);
/**
 * @swagger
 * /api/cards/{id}:
 *   get:
 ...
 */
cardRouter.get('/:id', card_controllers_1.getCardById);
/**
 * @swagger
 * /api/cards:
 *   post:
 ...
 */
cardRouter.post('/', card_controllers_1.createCard);
/**
 * @swagger
 * /api/cards/{id}:
 *   put:
 ...
 */
cardRouter.put('/:id', card_controllers_1.updateCard);
/**
 * @swagger
 * /api/cards/{id}:
 *   delete:
 ...
 */
cardRouter.delete('/:id', card_controllers_1.deleteCard);
/**
 * @swagger
 * /api/cards/sync:
 *   post:
 ...
 */
cardRouter.post('/sync', card_controllers_1.syncCards);
